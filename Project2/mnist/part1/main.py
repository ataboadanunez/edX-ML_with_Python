...
if False:
	...
	print('Linear Regression (L = 1) test_error =', run_linear_regression_on_MNIST(lambda_factor=1))
	print('Linear Regression (L = 0.1) test_error =', run_linear_regression_on_MNIST(lambda_factor=0.1))
	print('Linear Regression (L = 0.01) test_error =', run_linear_regression_on_MNIST(lambda_factor=0.01))
...
def run_softmax_on_MNIST(temp_parameter=1):
	...
	test_error_mod3 = compute_test_error_mod3(test_x, np.mod(test_y, 3), theta, temp_parameter)
...
if False:
	...
	print('trained softmax with PCA. test_error=', test_error)
...
print("training softmax after applying cubic kernel. test_error= ", test_error_cube)
