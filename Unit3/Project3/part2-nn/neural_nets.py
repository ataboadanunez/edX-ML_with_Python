...
class NeuralNetwork():
    ...
    def train(self, x1, x2, y):
        ...
        # vectorize functions before usage
        ...
        hidden_layer_error = np.multiply(output_der_vec(activated_output), self.hidden_to_output_weights.T) * output_layer_error 

        bias_gradients = np.multiply(hidden_layer_error, relu_der_vec(hidden_layer_weighted_input))
